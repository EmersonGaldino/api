using Dapper;
using galdino.funcional.domain.core.Exception.Table;
...
namespace galdino.funcional.data.persistence.Repository.Base
{
	public class RepositoryBase<T> : IRepositoryBase<T> where T : class
	{
        ...
        /// <summary>
        /// reponsavel por clonar todas as propriedades da classe que sao publicas e nao privadas
        /// </summary>
        /// <param name="souce">objeto a ser espelhado</param>
        /// <param name="destiny">objeto de destino</param>
        /// <returns>objeto de destino preenchido com os dados do objeto de origem</returns>
        ...
        /// <summary>
        /// reponsavel por clonar todas as propriedades da lista da classe que sao publicas e nao privadas
        /// </summary>
        /// <param name="souce">objeto a ser espelhado</param>
        /// <param name="destiny">objeto de destino</param>
        /// <returns>lista do objeto de destino preenchido com os dados do objeto de origem</returns>
        ...
        /// <summary>
        /// Responsavel por retornar as propriedades que sao publicas e nao virtuais da classe em questao
        /// </summary>
        /// <param name="type">tipo da classe</param>
        /// <returns>lista com todas as propriedades somente publicas e nao virtuais da classe</returns>
